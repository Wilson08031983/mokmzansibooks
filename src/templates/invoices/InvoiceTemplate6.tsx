...
/**
 * Invoice Template 6 - Blue Corporate Design
 * Based on Canva template: https://www.canva.com/design/DAGnJ1NnlkQ/bWTfvU4ajw4UbkegzISPmA/
 */
const InvoiceTemplate6: React.FC<InvoiceTemplateProps> = ({
  invoiceNumber,
  date,
  dueDate,
  companyDetails,
    ...
    >
      ...
      <div className="flex justify-between items-start mb-12 pt-4">
        ...
        <div className="text-right">
          <h2 className="text-4xl font-bold mb-6 text-blue-800">INVOICE</h2>
      ...
      <div className="bg-white bg-opacity-90 p-6 rounded-lg shadow-sm">
        ...
        <div className="flex justify-between mb-8">
          <div className="w-1/2 pr-4">
            <h3 className="text-lg font-bold text-blue-800 mb-2 border-b border-blue-400 pb-1">Bill To:</h3>
        ...
        {companyDetails.bankDetails && (
          <div className="mb-8">
            <h3 className="text-lg font-bold text-blue-800 mb-2 border-b border-blue-400 pb-1">Payment Information</h3>
            <div className="bg-gradient-to-r from-blue-50 to-white p-4 rounded-lg border-l-4 border-blue-500">
              ...
              <p className="text-blue-600 mt-2 font-medium">Please use invoice number as payment reference</p>
            </div>
          </div>
        )}
