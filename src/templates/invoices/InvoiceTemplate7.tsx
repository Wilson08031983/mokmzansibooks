...
/**
 * Invoice Template 7 - Green Nature Design
 * Based on Canva template: https://www.canva.com/design/DAGnJ5mdMWY/83IUJyjUOAfQA0xiQ_yQQw/
 */
const InvoiceTemplate7: React.FC<InvoiceTemplateProps> = ({
  invoiceNumber,
  date,
  dueDate,
  companyDetails,
    ...
    >
      ...
      <div className="flex justify-between items-start mb-10 pt-4">
        ...
        <div className="text-right">
          <h2 className="text-4xl font-bold mb-4 text-green-800">INVOICE</h2>
      ...
      <div className="bg-white bg-opacity-95 p-6 rounded-lg shadow-md">
        ...
        <div className="flex justify-between mb-8">
          <div className="w-1/2 pr-4">
            <h3 className="text-lg font-bold text-green-700 mb-2 border-b-2 border-green-200 pb-1">Bill To:</h3>
        ...
        {companyDetails.bankDetails && (
          <div className="mb-8">
            <h3 className="text-lg font-bold text-green-700 mb-2 border-b-2 border-green-200 pb-1">Payment Information</h3>
            <div className="bg-gradient-to-r from-green-50 to-white p-4 rounded-lg border-l-4 border-green-500">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <p>{companyDetails.bankDetails.bankName}</p>
                  <p>{companyDetails.bankDetails.accountName}</p>
                  <p>{companyDetails.bankDetails.accountNumber}</p>
                  <p>{companyDetails.bankDetails.branchCode}</p>
                </div>
              </div>
              <p className="text-green-600 mt-3 font-medium text-center">Please use invoice number {invoiceNumber} as payment reference</p>
            </div>
          </div>
        )}
