      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
              <Card className="p-6">
                <FormField control={form.control} name="quoteNumber" render={({
                field
              }) => <FormItem>
                ...
                <FormField control={form.control} name="issueDate" render={({
                field
              }) => <FormItem>
                ...
                field
                      ...
                      <FormControl>
                        <Input placeholder="Brief description of this quote" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>} />

                <FormField control={form.control} name="client" render={({
                field
              }) => <FormItem>
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent>
                          {getAllClients().map(client => <SelectItem key={client.id} value={client.id}>
                ...
                <FormField control={form.control} name="vatRate" render={({
                field
              }) => <FormItem>
                ...
                <div className="mt-6 border-t pt-6">
                  ...
                  <FormField control={form.control} name="accountName" render={({
                  field
                }) => <FormItem>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <FormField control={form.control} name="branchCode" render={({
                    field
                  }) => <FormItem>
                  ...
                  <FormField control={form.control} name="swiftCode" render={({
                  field
                }) => <FormItem>
                ...
                field
                      ...
                      <FormControl>
                        <Textarea placeholder="Notes about the quote" className="resize-none" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>} />
                ...
                field
                      ...
                      <FormControl>
                        <Textarea placeholder="Terms and conditions" className="resize-none" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>} />
              </Card>
                ...
                <ScrollArea className="h-[500px] w-full overflow-hidden border rounded-md">
                  <table className="w-full min-w-[900px] table-fixed">
                    ...
                    <tbody className="px-4">
                      {items.map((item, index) => <tr key={item.id} className="grid grid-cols-12 gap-4 mb-6 items-center px-4 py-2">
                          ...
                          <td className="col-span-2">
                            <Input type="text" value={formatCurrency(item.amount)} readOnly className="w-full text-center bg-gray-50" />
                          </td>
                          <td className="col-span-1 flex justify-center">
                            <Button type="button" variant="destructive" size="icon" onClick={() => handleRemoveItem(item.id)} className="h-8 w-8">
            ...
            <div>
              <div className="flex justify-between items-center mb-4">
                ...
                <Button type="button" variant="outline" onClick={handleDownloadQuote} className="flex items-center gap-2">
                  <Download size={16} />
                  Download PDF
                </Button>
              </div>
              <div className="bg-gray-100 p-4 rounded-lg border border-gray-200 overflow-hidden" style={{
              height: '842px'
            }}>
                <div className="w-full h-full flex justify-center items-start overflow-auto" ref={quoteTemplateRef}>
                  <div className="scale-[0.55] origin-top transform-gpu" style={{
                  width: '210mm',
