    ...
    <div className="w-[210mm] h-[297mm] bg-white p-8 shadow-lg mx-auto font-sans relative overflow-hidden">
      ...
      <div className="relative z-10 flex justify-between items-start">
        <div className="space-y-1">
          <div className="inline-block bg-blue-600 text-white font-bold text-4xl py-2 px-4">
            INVOICE
          </div>
      ...
      <div className="relative z-10 mt-12 grid grid-cols-2 gap-8">
        <div className="space-y-4">
          <div className="space-y-1">
            <h3 className="font-bold text-blue-600">FROM</h3>
          ...
          <div className="space-y-1">
            <h3 className="font-bold text-blue-600">TO</h3>
      ...
      <div className="relative z-10 mt-12">
        ...
        <div className="mt-4 flex justify-end">
          <div className="w-1/3 space-y-2">
            ...
            <div className="flex justify-between py-2 bg-blue-600 text-white px-4">
      ...
      <div className="relative z-10 mt-8 grid grid-cols-2 gap-6">
        <div>
          <h3 className="font-bold text-blue-600 border-b border-blue-200 pb-1 mb-3">Notes</h3>
          <p className="text-gray-600">{displayData.notes}</p>
        </div>
        <div>
          <h3 className="font-bold text-blue-600 border-b border-blue-200 pb-1 mb-3">Terms & Conditions</h3>
