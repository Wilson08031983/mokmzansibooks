  ...
  return (
    <div className="bg-white text-black font-sans">
      ...
      <div className="grid grid-cols-2 gap-8 mb-8">
        <div>
          <h3 className="font-medium text-blue-600 uppercase text-sm mb-2">Quote To</h3>
        ...
        <div className="text-right">
          <div className="space-y-1">
            <h3 className="font-medium text-blue-600 uppercase text-sm mb-2">Quote Details</h3>
        ...
        <table className="w-full">
          <thead>
            <tr className="bg-gray-50 text-left text-gray-700">
              ...
              <th className="py-3 px-4 text-right">Price (R)</th>
              <th className="py-3 px-4 text-right">Mark Up %</th>
              <th className="py-3 px-4 text-right">Discount</th>
              <th className="py-3 px-4 text-right rounded-tr-lg">Total (R)</th>
            </tr>
          </thead>
          <tbody>
            {data.items.map((item, index) => (
              <tr key={index} className={index % 2 === 0 ? "bg-gray-50" : "bg-white"}>
                ...
                <td className="py-3 px-4 text-right">{formatCurrency(item.unitPrice, "ZAR")}</td>
                <td className="py-3 px-4 text-right">{item.markupPercentage || 0}%</td>
